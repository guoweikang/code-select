 ...
 */
void sm4_setkey_enc(SM4_CTX *ctx, unsigned char key[16])
{
 ...
 */
void sm4_setkey_dec(SM4_CTX *ctx, unsigned char key[16])
{
  int i;
  ctx->mode = SM4_ENCRYPT;
  sm4_setkey(ctx->sk, key);
...
void sm4_crypt_ecb(SM4_CTX *ctx,
                   int mode,
                   int length,
                   unsigned char *input,
 ...
 */
void sm4_crypt_cbc(SM4_CTX *ctx,
                   int mode,
                   int length,
                   unsigned char iv[16],
                   unsigned char *input,
